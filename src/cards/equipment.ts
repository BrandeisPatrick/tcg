 ...
 *   - Durations always read "for N turns"; equipment buffs are implicitly
 *     permanent so we omit "(permanent)" qualifiers
...
export const EQUIPMENT: EquipmentCard[] = [
  ...
  { id: 'berserker',            name: 'Berserker',             type: 'equipment', rarity: 2, tier: 2, cost: 3, abilities: ['eff_berserker'],  text: 'On attach: +1 Weapon Power.' },
  ...
  { id: 'melee_lifesteal',      name: 'Melee Lifesteal',       type: 'equipment', rarity: 2, tier: 2, cost: 3, abilities: ['eff_melee_lifesteal'], text: 'After attacking: heal bearer 1.' },
  ...
  { id: 'frenzy',               name: 'Frenzy',                type: 'equipment', rarity: 3, tier: 3, cost: 4, abilities: ['eff_frenzy'],     text: '+1 Weapon Power.' },
  { id: 'diviners_kevlar',      name: "Diviner's Kevlar",      type: 'equipment', rarity: 3, tier: 3, cost: 4, abilities: ['eff_diviners_kevlar'], bonus: { hp: 2 }, text: '+2 HP, Spirit Resist 4.' },
