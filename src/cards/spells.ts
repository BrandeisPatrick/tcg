...
export const SPELLS: SpellCard[] = [
  ...
  { id: 'decay',               name: 'Decay',               type: 'spell', rarity: 2, cost: 2, abilities: ['eff_decay'],               text: 'Apply Bleed 2 to enemy Active for 3 turns.' },
  ...
  { id: 'return_fire',         name: 'Return Fire',         type: 'spell', rarity: 2, cost: 2, abilities: ['eff_return_fire'],         text: 'Grant ally Active Bullet Resist 3 for 1 turn.' },
  ...
  { id: 'metal_skin',          name: 'Metal Skin',          type: 'spell', rarity: 3, cost: 3, abilities: ['eff_cast_metal_skin'],     text: 'Grant ally Active Bullet Resist 3 for 2 turns.' },
