...
export const ULTIMATES: UltimateCard[] = [
  ...
  { id: 'ult_dynamo',     name: 'Singularity',     type: 'ultimate', rarity: 4, cost: 9, linkedHero: 'hero_dynamo',     abilities: ['eff_ult_dynamo'],     text: 'Dynamo channels for 3 turns — he cannot attack or use skills, and deals 3 spirit to all enemies at the end of each turn. Stun / Sleep interrupts a pulse.' },
  ...
  { id: 'ult_seven',      name: 'Storm Cloud',     type: 'ultimate', rarity: 4, cost: 8, linkedHero: 'hero_seven',      abilities: ['eff_ult_seven'],      text: 'Seven channels for 3 turns — he cannot attack or use skills, and rains an escalating 2 → 3 → 4 spirit on all enemies at the end of each turn. Stun / Sleep interrupts a pulse.' },
  ...
  { id: 'ult_warden',     name: 'Last Stand',       type: 'ultimate', rarity: 4, cost: 9, linkedHero: 'hero_warden',     abilities: ['eff_ult_warden'],     text: 'Warden channels for 3 turns while still attacking and using skills — deals 2 spirit to all enemies at the end of each turn and heals for half the total.' },
