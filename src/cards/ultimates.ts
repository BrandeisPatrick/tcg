...
export const ULTIMATES: UltimateCard[] = [
  ...
  { id: 'ult_viscous',    name: 'Goo Ball',        type: 'ultimate', rarity: 4, cost: 6, linkedHero: 'hero_viscous',    abilities: ['eff_ult_viscous'],    text: 'Bearer Invincibility 2 + 3 bullet dmg to enemy Active.' },
