...
export const ULTIMATES: UltimateCard[] = [
  ...
  { id: 'ult_paige',      name: 'Rallying Charge', type: 'ultimate', rarity: 4, cost: 6, linkedHero: 'hero_paige',      abilities: ['eff_ult_paige'],      text: 'All allies +2 Bullet Power for 2 turns.' },
  ...
  { id: 'ult_yamato',     name: 'Shadow Transformation', type: 'ultimate', rarity: 4, cost: 5, linkedHero: 'hero_yamato', abilities: ['eff_ult_yamato'],  text: 'Bearer gains +3 Bullet Power and Unstoppable for 2 turns.' },
