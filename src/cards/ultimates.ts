...
export const ULTIMATES: UltimateCard[] = [
  ...
  { id: 'ult_haze',       name: 'Bullet Dance',    type: 'ultimate', rarity: 4, cost: 6, linkedHero: 'hero_haze',       abilities: ['eff_ult_haze'],       text: 'Deal 2 attack dmg to every enemy.' },
  { id: 'ult_kelvin',     name: 'Frozen Shelter',  type: 'ultimate', rarity: 4, cost: 7, linkedHero: 'hero_kelvin',     abilities: ['eff_ult_kelvin'],     text: 'All allies gain Invincibility 1.' },
  ...
  { id: 'ult_lash',       name: 'Death Slam',      type: 'ultimate', rarity: 4, cost: 5, linkedHero: 'hero_lash',       abilities: ['eff_ult_lash'],       text: '6 dmg to enemy Active.' },
  ...
  { id: 'ult_paige',      name: 'Surge of Power',  type: 'ultimate', rarity: 4, cost: 6, linkedHero: 'hero_paige',      abilities: ['eff_ult_paige'],      text: 'All allies +2 ATK for 2 turns.' },
  { id: 'ult_rem',        name: 'Mass Heal',       type: 'ultimate', rarity: 4, cost: 7, linkedHero: 'hero_rem',        abilities: ['eff_ult_rem'],        text: 'Heal all allies for 4.' },
  ...
  { id: 'ult_shiv',       name: 'Bloodletting',    type: 'ultimate', rarity: 4, cost: 5, linkedHero: 'hero_shiv',       abilities: ['eff_ult_shiv'],       text: 'Apply Bleed 3 to enemy Active.' },
  { id: 'ult_sinclair',   name: 'Mystic Surge',    type: 'ultimate', rarity: 4, cost: 5, linkedHero: 'hero_sinclair',   abilities: ['eff_ult_sinclair'],   text: 'Refresh all ally hero skills.' },
  { id: 'ult_vindicta',   name: 'Assassinate',     type: 'ultimate', rarity: 4, cost: 5, linkedHero: 'hero_vindicta',   abilities: ['eff_ult_vindicta'],   text: '5 dmg to any enemy.' },
  ...
  { id: 'ult_drifter',    name: 'Eternal Night',    type: 'ultimate', rarity: 4, cost: 5, linkedHero: 'hero_drifter',    abilities: ['eff_ult_drifter'],    text: 'Silence all enemy bench heroes for 2 turns.' },
];
