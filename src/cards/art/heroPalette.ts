...
export const HERO_IDENTITY: Record<string, HeroIdentity> = {
  ...
  hero_mo_krill:  { primary: '#e0a96d', accent: '#3a230c', role: 'marksman', glyph: 'gear',      initial: 'M' },
  ...
  hero_sinclair:  { primary: '#d96fa3', accent: '#4a1d36', role: 'bruiser', glyph: 'gear',      initial: 'S' },
  ...
  hero_yamato:    { primary: '#ff5a8c', accent: '#4a162a', role: 'caster',  glyph: 'flame',     initial: 'Y' },
};
